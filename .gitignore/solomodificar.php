...
<center>
 <div class="media">
            ...
            <button type="button" class="btn btn-primary1" style="background= silver; " onclick = "location='http://localhost/LimpiandoAndoLtda/Crear.php'">Crear Nuevo Articulo </button> 
          &nbsp;</div>
        </div>
<br></br>
<br></br>
<br></br>
<h1 <a class="btn btn-primary btn-lg" style="background: gray;" role="main">  __________________ Modificar Articulos Actuales ___________________  </a>   </h1>
...
<table  border="5"  >
		...
		<tr>
			...
			<th><center>Acciones<br></br></center></th>
		</tr>
		...
		?>		
			<tr>
			 ...
			 <td> <center> <img height= "70px" src="data:image/jpg;base64,<?php echo base64_encode($row['imag_articulo']); ?>" /> </center></td>
